...
export const PACKAGES: Package[] = [
  ...
  },
  {
    ...
    name: 'RFLCT Basis',
    price: 2850,
    kernpositionering: 'Begeleiding waar het nodig is. Volledige coaching tot lancering: intake, verkoopplan, prijsadvies, attestbegeleiding, professionele fotografie, virtual staging, 2D+3D grondplan, Premium Immoweb 1m, social, webpagina, gevelbord.',
    tags: ['Volledig coaching', 'Professionele fotografie', 'Virtual staging', '2D+3D grondplan'],
  },
  {
    id: 'compleet',
    name: 'RFLCT Compleet',
